...
class valueSetter():
    def __init__ (self, clk, dio, enca, encb, butt, minValue=0, maxValue=100, precision=1, ratio=1 ,pratio=0, vinit=None):
        ...
        time.sleep(1)
        self.display.write(self.display.encode_string("{:{w}.{p}f}".format(self.value, w = self.width, p = self.precision)))
...
if __name__ == '__main__':
    ...
    testSetter = valueSetter(clockPin, dioPin, encoderaPin, encoderbPin, encoderButtonPin)
